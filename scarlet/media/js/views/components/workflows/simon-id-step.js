...
import simonIdStep from 'templates/views/components/plugins/simon-id-step.htm';
...
var viewModel = function(params) {
    ...
    this.fetchTileData = async(resourceId, nodeId) => {
        const tilesResponse = await window.fetch(
            generateArchesURL("resource_tiles", {resourceid: resourceId}) +
...
export default ko.components.register('simon-id-step', {
    viewModel: viewModel,
