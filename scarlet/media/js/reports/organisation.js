define([
    ...
    'utils/resource',
    'utils/report',
    'templates/views/reports/organisation.htm',
    './REPORT-SPECIFICATION.json',
    'views/name',
    'views/addresses',
    'views/work-events',
    'views/productive-activity',
    'views/research-and-recognition',
    'views/appointments',
    'views/legal-and-financial',
    'views/sources',
], function($, _, ko, arches, resourceUtils, reportUtils, organisationReportTemplate, reportSpecification) {
    return ko.components.register('organisation-report', {
